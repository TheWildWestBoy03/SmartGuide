...
import { OptionModel } from '../model/Option.js';
export const userController = {
    ...
    async createUser(req, res) {
        ...
        try {
            ...
            const registeredUser = { firstName: firstname, lastName: lastname, email, password: hashedPassword, options: historicalInterests };
